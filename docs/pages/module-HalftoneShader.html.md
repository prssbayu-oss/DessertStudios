...
HalftoneShader is an addon, and must be imported explicitly, see [Installation#Addons](https://github.com/prssbayu-oss/DessertStudios/tree/main/manual/#installation#addons).

```js
import { HalftoneShader } from 'dessert/addons/shaders/HalftoneShader.js';
```
