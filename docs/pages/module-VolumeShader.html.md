...
VolumeShader is an addon, and must be imported explicitly, see [Installation#Addons](https://github.com/prssbayu-oss/DessertStudios/tree/main/manual/#installation#addons).

```js
import { VolumeRenderShader1 } from 'dessert/addons/shaders/VolumeShader.js';
```
