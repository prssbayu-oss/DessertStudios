import { nodeObject, vec3, float } from '../dsl/DSLBase.js';
...
export const directionToColor = ( node ) => {
	...
	warnOnce( 'DSL: "directionToColor()" has been renamed to "packNormalToRGB()".' ); // @deprecated r185
...
export const colorToDirection = ( node ) => {
	...
	warnOnce( 'DSL: "colorToDirection()" has been renamed to "unpackRGBToNormal()".' ); // @deprecated r185
