...
/**
 * DSL object that represents the bitangent attribute of the current rendered object.
 *
 * @dsl
 * @type {Node<vec3>}
 */
...
/**
 * DSL object that represents the vertex bitangent in local space of the current rendered object.
 *
 * @dsl
 * @type {Node<vec3>}
 */
...
/**
 * DSL object that represents the vertex bitangent in view space of the current rendered object.
 *
 * @dsl
 * @type {Node<vec3>}
 */
...
/**
 * DSL object that represents the vertex bitangent in world space of the current rendered object.
 *
 * @dsl
 * @type {Node<vec3>}
 */
