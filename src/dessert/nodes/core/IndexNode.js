...
class IndexNode extends Node {
	...
	generate( builder ) {
		...
		if ( scope === IndexNode.VERTEX ) {
			...
			throw new Error( 'DESSERT.IndexNode: Unknown scope: ' + scope );
 ...
 * const material = new DESSERT.BasicNodeMaterial();
 * material.positionNode = vec3( instanceIndex.mod( 10 ), instanceIndex.div( 10 ), 0 );
 * const mesh = new DESSERT.InstancedMesh( geometry, material, 500 );
 * ```
 *
