...
export * from './Dessert.Legacy.js';

if ( typeof __DESSERT_DEVTOOLS__ !== 'undefined' ) {

	__DESSERT_DEVTOOLS__.dispatchEvent( new CustomEvent( 'register', { detail: {
		revision: REVISION,
	} } ) );
...
if ( typeof window !== 'undefined' ) {
	...
	if ( window.__DESSERT__ ) {

		warn( 'WARNING: Multiple instances of Dessert.js being imported.' );

	} else {

		window.__DESSERT__ = REVISION;
