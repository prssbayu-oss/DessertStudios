...
class NodeLibrary {
	...
	addType( nodeClass, type, library ) {
		...
		if ( typeof nodeClass !== 'function' ) throw new Error( `DESSERT.NodeLibrary: Node class ${ nodeClass.name } is not a class.` );
		if ( typeof type === 'function' || typeof type === 'object' ) throw new Error( `DESSERT.NodeLibrary: Base class ${ type } is not a class.` );
	...
	addClass( nodeClass, baseClass, library ) {
		...
		if ( typeof nodeClass !== 'function' ) throw new Error( `DESSERT.NodeLibrary: Node class ${ nodeClass.name } is not a class.` );
		if ( typeof baseClass !== 'function' ) throw new Error( `DESSERT.NodeLibrary: Base class ${ baseClass.name } is not a class.` );
