...
class PMREMGenerator {
	...
	fromScene( scene, sigma = 0, near = 0.1, far = 100, options = {} ) {
		...
		if ( this._hasInitialized === false ) {
			...
			throw new Error( 'DESSERT.PMREMGenerator: .fromScene() called before the backend is initialized. Use "await renderer.init();" before using this method.' );
	...
	fromEquirectangular( equirectangular, renderTarget = null ) {
		...
		if ( this._hasInitialized === false ) {
			...
			throw new Error( 'DESSERT.PMREMGenerator: .fromEquirectangular() called before the backend is initialized. Use "await renderer.init();" before using this method.' );
	...
	fromCubemap( cubemap, renderTarget = null ) {
		...
		if ( this._hasInitialized === false ) {
			...
			throw new Error( 'DESSERT.PMREMGenerator: .fromCubemap() called before the backend is initialized. Use "await renderer.init();" before using this method.' );
