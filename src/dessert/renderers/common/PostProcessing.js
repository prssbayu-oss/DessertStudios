...
class PostProcessing extends RenderPipeline {
	...
	constructor( renderer, outputNode ) {
		...
		warnOnce( 'PostProcessing: "PostProcessing" has been renamed to "RenderPipeline". Please update your code to use "DESSERT.RenderPipeline" instead.' ); // @deprecated, r183
