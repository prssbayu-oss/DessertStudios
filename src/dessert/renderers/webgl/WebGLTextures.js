...
function WebGLTextures( _gl, extensions, state, properties, capabilities, utils, info ) {
	...
	function setupDepthTexture( framebuffer, renderTarget, cubeFace ) {
		...
		if ( ! ( renderTarget.depthTexture && renderTarget.depthTexture.isDepthTexture ) ) {
			...
			throw new Error( 'DESSERT.WebGLTextures: renderTarget.depthTexture must be an instance of DESSERT.DepthTexture.' );
		...
		if ( renderTarget.depthTexture.format === DepthFormat ) {
			...
			throw new Error( 'DESSERT.WebGLTextures: Unknown depthTexture format.' );
