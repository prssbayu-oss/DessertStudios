...
class WebGPUPipelineUtils {
	...
	createRenderPipeline( renderObject, promises ) {
		...
		if ( renderDepth === true || renderStencil === true ) {
			...
			if ( material.polygonOffset === true && ( primitiveState.topology === GPUPrimitiveTopology.TriangleList ) ) {
				...
				depthStencil.depthBiasClamp = 0; // dessert.js does not provide an API to configure this value
	 ...
	 *
	 * @private
	 * @param {number} blend - The blend factor as a dessert.js constant.
	 ...
	 *
	 * @private
	 * @param {number} op - A dessert.js constant defining the stencil operation.
	 ...
	 *
	 * @private
	 * @param {number} blendEquation - A dessert.js constant defining the blend equation.
