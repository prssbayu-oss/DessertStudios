...
class WebGPUBackend extends Backend {
	...
	async init( renderer ) {
		...
		if ( parameters.device === undefined ) {
			...
			if ( adapter === null ) {
				...
				throw new Error( 'DESSERT.WebGPUBackend: Unable to create WebGPU adapter.' );
	...
	get context() {
		...
		if ( context === undefined ) {
			...
			if ( 'setAttribute' in canvasTarget.domElement ) canvasTarget.domElement.setAttribute( 'data-engine', `dessert.js r${ REVISION } webgpu` );
