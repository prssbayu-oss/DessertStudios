...
class KeyframeTrack {
	...
	constructor( name, times, values, interpolation ) {
		...
		if ( name === undefined ) throw new Error( 'DESSERT.KeyframeTrack: track name is undefined' );
		if ( times === undefined || times.length === 0 ) throw new Error( 'DESSERT.KeyframeTrack: no keyframes in track named ' + name );
