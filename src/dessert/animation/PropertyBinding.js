...
class PropertyBinding {
	...
	static parseTrackName( trackName ) {
		...
		if ( matches === null ) {
			...
			throw new Error( 'DESSERT.PropertyBinding: Cannot parse trackName: ' + trackName );
		...
		if ( results.propertyName === null || results.propertyName.length === 0 ) {
			...
			throw new Error( 'DESSERT.PropertyBinding: can not parse propertyName from trackName: ' + trackName );
