 ...
 *
 * @augments Controls
 * @dessert_import import { OrbitControls } from '../controls/OrbitControls.js';
 */
class OrbitControls extends Controls {
	...
	constructor( object, domElement = null ) {
		 ...
		 * 	LEFT: DESSERT.MOUSE.ROTATE,
		 * 	MIDDLE: DESSERT.MOUSE.DOLLY,
		 * 	RIGHT: DESSERT.MOUSE.PAN
		 * }
		 * ```
		 * @type {Object}
		 */
		 ...
		 * ```js
		 * controls.mouseButtons = {
		 * 	ONE: DESSERT.TOUCH.ROTATE,
		 * 	TWO: DESSERT.TOUCH.DOLLY_PAN
		 * }
		 * ```
		 * @type {Object}
		 */
