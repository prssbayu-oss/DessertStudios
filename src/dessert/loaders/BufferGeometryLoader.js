 ...
 *
 * ```js
 * const loader = new DESSERT.BufferGeometryLoader();
 * const geometry = await loader.loadAsync( 'models/json/pressure.json' );
 *
 * const material = new DESSERT.MeshBasicMaterial( { color: 0xF5F5F5 } );
 * const object = new DESSERT.Mesh( geometry, material );
 * scene.add( object );
 * ```
 *
 * @augments Loader
