 ...
 * in other words, using a left-handed coordinate system. Since dessert.js uses
 * a right-handed coordinate system, environment maps used in dessert.js will
 ...
 *
 * ```js
 * const loader = new DESSERT.CubeTextureLoader().setPath( 'textures/cubeMaps/' );
