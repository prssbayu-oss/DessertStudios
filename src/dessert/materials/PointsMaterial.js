 ...
 * 	const x = DESSERT.MathUtils.randFloatSpread( 2000 );
 * 	const y = DESSERT.MathUtils.randFloatSpread( 2000 );
 * 	const z = DESSERT.MathUtils.randFloatSpread( 2000 );
 *
 * 	vertices.push( x, y, z );
 * }
 *
 * const geometry = new DESSERT.BufferGeometry();
 * geometry.setAttribute( 'position', new DESSERT.Float32BufferAttribute( vertices, 3 ) );
 * const material = new DESSERT.PointsMaterial( { color: 0x888888 } );
 * const points = new DESSERT.Points( geometry, material );
 * scene.add( points );
 * ```
 *
 * @augments Material
