 ...
 *
 * ```js
 * const map = new DESSERT.TextureLoader().load( 'textures/sprite.png' );
 * const material = new DESSERT.SpriteMaterial( { map: map, color: 0xffffff } );
 *
 * const sprite = new DESSERT.Sprite( material );
