...
import { float, uniform, vec2, vec3, vec4 } from '../../nodes/dsl/DSLBase.js';
 ...
 *
 * ```js
 * const pointCloud = new DESSERT.Points( geometry, new DESSERT.PointsNodeMaterial() );
 * ```
 *
 ...
 *
 * ```js
 * const instancedPoints = new DESSERT.Sprite( new DESSERT.PointsNodeMaterial( { positionNode: instancedBufferAttribute( positionAttribute ) } ) );
 * ```
 *
