...
class Material extends EventDispatcher {
	...
	constructor() {
		...
		/**
		 * User-defined clipping planes specified as DESSERT.Plane objects in world
	 ...
	 * values of settings used in `onBeforeCompile()`, so dessert.js can reuse a cached
	...
	setValues( values ) {
		...
		for ( const key in values ) {
			...
			if ( currentValue === undefined ) {
				...
				warn( `Material: '${ key }' is not a property of DESSERT.${ this.type }.` );
				continue;
