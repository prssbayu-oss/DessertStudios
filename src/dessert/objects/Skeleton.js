...
/**
 * Class for representing the armatures in `dessert.js`. The skeleton
 * is defined by a hierarchy of bones.
 *
 * ```js
 * const bones = [];
 *
 * const shoulder = new DESSERT.Bone();
 * const elbow = new DESSERT.Bone();
 * const hand = new DESSERT.Bone();
 *
 * shoulder.add( elbow );
 * elbow.add( hand );
 *
 ...
 * hand.position.y = 5;
 *
 * const armSkeleton = new DESSERT.Skeleton( bones );
 * ```
 */
class Skeleton {
