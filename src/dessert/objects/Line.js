 ...
 *
 * ```js
 * const material = new DESSERT.LineBasicMaterial( { color: 0x0000ff } );
 *
 * const points = [];
 * points.push( new DESSERT.Vector3( - 10, 0, 0 ) );
 * points.push( new DESSERT.Vector3( 0, 10, 0 ) );
 * points.push( new DESSERT.Vector3( 10, 0, 0 ) );
 *
 * const geometry = new DESSERT.BufferGeometry().setFromPoints( points );
 *
 * const line = new DESSERT.Line( geometry, material );
 * scene.add( line );
 * ```
 *
 * @augments Object3D
