 ...
 *
 * ```js
 * const box = new DESSERT.Box3();
 * box.setFromCenterAndSize( new DESSERT.Vector3( 1, 1, 1 ), new DESSERT.Vector3( 2, 1, 3 ) );
 *
 * const helper = new DESSERT.Box3Helper( box, 0xffff00 );
 * scene.add( helper )
 * ```
 *
