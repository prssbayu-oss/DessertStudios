		...
		async function loadFile( file ) {
			...
			if ( cache.has( hash ) ) {
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { HDRLoader } = await import( 'dessert/addons/loaders/HDRLoader.js' );
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { TGALoader } = await import( 'dessert/addons/loaders/TGALoader.js' );
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					const { EXRLoader } = await import( 'dessert/addons/loaders/EXRLoader.js' );
