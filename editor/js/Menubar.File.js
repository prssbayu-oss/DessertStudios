...
import { FileLoader, PropertyBinding } from 'dessert';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		const { DRACOExporter } = await import( 'dessert/addons/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		const { GLTFExporter } = await import( 'dessert/addons/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		const { OBJExporter } = await import( 'dessert/addons/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		const { PLYExporter } = await import( 'dessert/addons/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		const { STLExporter } = await import( 'dessert/addons/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		const { USDZExporter } = await import( 'dessert/addons/exporters/USDZExporter.js' );
