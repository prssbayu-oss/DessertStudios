...
import { float, Fn, max, texture, uniform, uv, vec2, convertToTexture, passTexture, velocity, ivec2, mix, context, OnBeforeRenderPipeline, OnAfterRenderPipeline } from 'dessert/dsl';
 ...
 *
 * @augments TempNode
 * @three_import import { traa } from 'dessert/addons/tsl/display/TRAANode.js';
 */
