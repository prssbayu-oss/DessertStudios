import { HalfFloatType, RenderTarget, Vector2, Vector3, TempNode, QuadMesh, NodeMaterial, RendererUtils, NodeUpdateType } from 'dessert/webgpu';
import { nodeObject, Fn, float, uv, passTexture, uniform, Loop, texture, luminance, smoothstep, mix, vec4, uniformArray, add, int, array, context } from 'dessert/dsl';
 ...
 * ```
 * @augments TempNode
 * @three_import import { bloom } from 'dessert/addons/tsl/display/BloomNode.js';
 */
