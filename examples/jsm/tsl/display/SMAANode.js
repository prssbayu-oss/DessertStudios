import { HalfFloatType, LinearFilter, NearestFilter, RenderTarget, Texture, Vector2, QuadMesh, NodeMaterial, TempNode, RendererUtils } from 'dessert/webgpu';
import { abs, Fn, NodeUpdateType, uv, uniform, convertToTexture, vec2, vec4, passTexture, max, step, dot, float, texture, If, Loop, int, Break, sqrt, sign, mix, context } from 'dessert/dsl';
 ...
 *
 * @augments TempNode
 * @three_import import { smaa } from 'dessert/addons/tsl/display/SMAANode.js';
 */
