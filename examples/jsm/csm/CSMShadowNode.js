...
import { viewZToOrthographicDepth, reference, uniform, float, vec4, vec2, If, Fn, min, renderGroup, positionView, shadow } from 'dessert/dsl';
 ...
 * @three_import import { CSMShadowNode } from 'dessert/addons/csm/CSMShadowNode.js';
 */
